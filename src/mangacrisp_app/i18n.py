...
ENGLISH_TRANSLATIONS = {
    ...
    "Dockアイコンを動かして保存枚数を表示する": "Animate the Dock icon and show the saved page count",
    "対象アプリを前面のまま、Dockアイコンの動きと数字で保存成功を知らせます。": "Confirms a successful save with Dock animation and a page count without bringing MangaCrisp to the front.",
    ...
    "待機中: {capture} で撮影 / {undo} で直前取消。Dockから管理画面を開けます。": "Ready: {capture} captures / {undo} undoes the last page. Open the controller from the Dock.",
