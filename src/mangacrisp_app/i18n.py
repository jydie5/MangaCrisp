...
ENGLISH_TRANSLATIONS = {
    ...
    "完成後に本棚へ追加": "Add to Bookshelf when complete",
    "完成ファイルを作成": "Create Finished File",
    ...
    "待機中: {capture} で撮影 / {undo} で直前取消。管理画面を最小化します。": "Ready: {capture} captures / {undo} undoes the last page. The controller will be minimized.",
    ...
    "完成ファイルにするページがありません。": "There are no pages to package.",
    "PNG保存が完了してから作成してください。": "Wait for PNG saving to finish before packaging.",
    "完成ファイルを作成中...": "Creating the finished file...",
    "完成ファイルを作成できません: {error}": "Could not create the finished file: {error}",
