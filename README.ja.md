...
**[Windows 10/11 x64 Development Previewをダウンロード](https://github.com/jydie5/MangaCrisp/releases/download/windows-preview-0.7.1b0.1/MangaCrisp-0.7.1b0-windows-x64-portable-preview.zip)**
...
4. 対象アプリでページを手動で送り、画像ごとにmacOSは`Option+C`、Windowsは
   `Alt+C`を1回押します。直前の撮影取消は`Option+Z`または`Alt+Z`です。
5. MangaCrispを開いて管理画面を戻し、`撮影を完了`を押します。
