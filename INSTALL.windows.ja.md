...
[MangaCrisp 0.5.0b0 Windows x64ポータブルpreview](https://github.com/jydie5/MangaCrisp/releases/download/windows-preview-0.5.0b0.1/MangaCrisp-0.5.0b0-windows-x64-portable-preview.zip)
